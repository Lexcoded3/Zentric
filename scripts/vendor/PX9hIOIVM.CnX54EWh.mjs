import { t as e } from "./rolldown-runtime.B3Ac26FU.mjs";
import {
  A as t,
  L as n,
  O as r,
  ...
  y as te,
  z as f,
} from "./react.RJBNjasc.mjs";
import { C as p, a as m, r as ne, t as re } from "./motion.SgNMloHC.mjs";
import {
  C as ie,
  D as h,
  F as g,
    ...
    return r && !i
      ...
      : s(e, {
          ...
          onClick: (e) => {
            (e.preventDefault(),
              f.open(
                `https://www.framer.com/r/badge/?utm_campaign=freeplanbadge&utm_source=${encodeURIComponent(f?.location?.origin)}`
              ));
          },
  ...
  he = e(() => {
    (l(),
      ...
      (P = v(
        ...
        [
          `.framer-g7oZR { -webkit-mask-image: ${D}; -webkit-mask-position: ${A}; -webkit-mask-repeat: ${k}; -webkit-mask-size: ${j}; aspect-ratio: 9.7; background-color: var(--1bd4d3i); mask-image: ${D}; mask-mode: ${O}; mask-position: ${A}; mask-repeat: ${k}; mask-size: ${j}; width: 97px; }`,
        ],
        `framer-g7oZR`
      )),
      (P.displayName = `Text`),
...
e(() => {
  (l(),
    ...
    (G = g(W)),
    (K = g(F)),
    (q = y(F, { nodeId: `pBR1Ew0r8`, override: pe, scopeId: `PX9hIOIVM` })),
    (J = ce(le(y(p.a, { nodeId: `HK2sXlagE`, override: fe, scopeId: `PX9hIOIVM` })))),
    (Y = `framer-6jWyo`),
    (X = { HK2sXlagE: `framer-v-n0ccwk` }),
    (_e = {
      opacity: 1,
      rotate: 0,
      rotateX: 0,
    ...
    (Q = v(
      a(function (e, t) {
        let n = r(null),
          i = t ?? n,
          a = te(),
          { activeLocale: o, setLocale: ee } = ae();
        se();
        let { style: l, className: u, layoutId: d, variant: f, ...m } = Ce(e),
          {
            ...
            setVariant: y,
            variants: b,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: X }),
          x = we(e, b),
          S = h(Y);
        return s(ne, {
          id: d ?? a,
            ...
            children: s(Se, {
              ...
              children: s(ue, {
                ...
                children: c(J, {
                  ...
                  __targetOpacity: 1,
                  className: `${h(S, `framer-n0ccwk`, u, ie)} framer-bmpgw8`,
    ...
    ie(Q, [{ explicitInter: !0, fonts: [] }, ...G, ...K], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.CnX54EWh.mjs.map
