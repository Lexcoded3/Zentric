...
var Icon = (React) => {
  if (!Component) {
    ...
    IconInner = React.forwardRef((props, ref) =>
      /* @__PURE__ */ React.createElement("g", { ref, ...props }, Component.get(props.weight))
    );
  }
  return IconInner;
};
...
var PresentationChart_default = Icon;
export { __FramerMetadata__, PresentationChart_default as default };
